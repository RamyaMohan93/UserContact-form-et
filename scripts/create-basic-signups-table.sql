...
-- Create a basic signups table that will definitely work
...
-- (This will be removed automatically due to the unique email constraint if run multiple times)
INSERT INTO public.signups (name, email, subject) 
VALUES ('Test User', 'test@example.com', 'Test Subject')
